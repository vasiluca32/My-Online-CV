    ...
    return (
        <div className="work-container">
            ...
            <div className="work">
                ...
                <div className="work-exp">
                    <div className="company-logo">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT_wbG1eypv5WoAlGooCYvYTt-n0YY5V_A9A-d72QSh6jGmXERd&usqp=CAU"></img>
                    </div>
                    <div className="text">
                ...
                <div className="work-exp">
                    <div className="company-logo">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTRyk1dQ4Bu0XIKKpDzDOF9TLNamp6DM94fzPNtUB1wUQ_L8m5c&usqp=CAU"></img>
                    </div>
                    <div className="text">
                        <h3>Hotel Opal</h3>
                        <br></br>
